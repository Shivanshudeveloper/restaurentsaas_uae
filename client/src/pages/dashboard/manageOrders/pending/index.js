...
const DineInTable = ({ deleteOrder, userId, toggler, openEditor, getFormattedDate }) => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_SERVICE}/get_orders_by_status/${userId}/${1}/${1}`)
      .then((res) => {
...
const DeliveryTable = ({ deleteOrder, userId, toggler, openEditor, getFormattedDate }) => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_SERVICE}/get_orders_by_status/${userId}/${1}/${2}`)
      .then((res) => {
        console.log(res.data)
        setFilteredOrders(res.data.reverse())
      })
...
const PickupTable = ({ deleteOrder, userId, toggler, openEditor, getFormattedDate }) => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_SERVICE}/get_orders_by_status/${userId}/${1}/${3}`)
      .then((res) => {
        console.log(res.data)
        setFilteredOrders(res.data.reverse())
      })
...
const PendingList = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>Pending Orders List</title>
      </Head>
      <Box
        component="main"
        sx={{
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid item container justifyContent="space-between" sx={{ mb: 4 }}>
              <Grid item>
                <Typography variant="h4">Pending Orders List</Typography>
              </Grid>
            </Grid>
            <Box
              sx={{
